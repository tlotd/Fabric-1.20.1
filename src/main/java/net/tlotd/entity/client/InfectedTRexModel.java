...
public class InfectedTRexModel<T extends InfectedTRexEntity> extends SinglePartEntityModel<T> {
	...
	public InfectedTRexModel(ModelPart root) {
	...
	@Override
	public void setAngles(InfectedTRexEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
